    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Editar usuario <strong>{{ $user->username }}</strong>
        ...
        <section class="content">
          ...
          <form class="form-horizontal" role="form" action="{{ url('user/update', $user->id) }}" method="post">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="username" placeholder="Usuario" value="{{ $user->username }}">
                </div>
              </div>
              <div class="form-group">
