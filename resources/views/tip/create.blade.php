    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <form class="form-horizontal" role="form" action="{{ url('tip/store') }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="box-body">
              <div class="form-group">
                <label for="name" class="col-sm-2 control-label">Contenido</label>
                <div class="col-sm-10">
                  <textarea class="form-control" rows="2" name="content" placeholder="Contenido (máx. 255 caracteres)" maxlength="255" style="resize: none;"></textarea>
                </div>
              </div>
              <div class="form-group">
                <label for="desde" class="col-sm-2 control-label">Desde</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" placeholder="Desde" name="start" id="start">
                </div>
              </div>
              <div class="form-group">
                <label for="hasta" class="col-sm-2 control-label">Hasta</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" placeholder="Hasta" name="end" id="end">
                </div>
              </div>
            </div><!-- /.box-body -->
