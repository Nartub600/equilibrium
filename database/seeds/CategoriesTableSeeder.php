...
class CategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::create([ 'id' => 114 , 'name' => 'AZÚCARES Y DULCES'  , 'parent' => 0,   'order' => 9 ]);
        ...
        Category::create([ 'id' => 131 , 'name' => 'Edulcorantes líquidos'  , 'parent' => 119, 'order' => 1 ]);
        ...
        Category::create([ 'id' => 134 , 'name' => 'BEBIDAS FRÍAS Y CALIENTES'  , 'parent' => 0,   'order' => 1 ]);
        Category::create([ 'id' => 135 , 'name' => 'Bebidas Frías'  , 'parent' => 134, 'order' => 1 ]);
        ...
        Category::create([ 'id' => 146 , 'name' => 'Dietéticas' , 'parent' => 144, 'order' => 2 ]);
        ...
        Category::create([ 'id' => 159 , 'name' => 'ENCURTIDOS Y COPETIN'    , 'parent' => 0,   'order' => 1 ]);
        Category::create([ 'id' => 160 , 'name' => 'Aceitunas, pickles y otros encurtidos'   , 'parent' => 159, 'order' => 1 ]);
        Category::create([ 'id' => 161 , 'name' => 'Productos de copetín'   , 'parent' => 159, 'order' => 2 ]);
        Category::create([ 'id' => 162 , 'name' => 'PLATOS PREPARADOS'   , 'parent' => 0,   'order' => 1 ]);
        Category::create([ 'id' => 163 , 'name' => 'Típicos argentinos' , 'parent' => 162, 'order' => 1 ]);
        Category::create([ 'id' => 164 , 'name' => 'Otros países o regiones'    , 'parent' => 162, 'order' => 2 ]);
        Category::create([ 'id' => 165 , 'name' => 'ALIMENTOS INFANTILES'    , 'parent' => 0,   'order' => 1 ]);
        ...
        Category::create([ 'id' => 169 , 'name' => 'COMER AFUERA'    , 'parent' => 0,   'order' => 1 ]);
        ...
        Category::create([ 'id' => 173 , 'name' => 'ALIMENTOS DIETOTERÁPICOS'   , 'parent' => 0,   'order' => 1 ]);
        ...
        Category::create([ 'id' => 184 , 'name' => 'ALIMENTOS PARA DIETAS ESPECIALES'    , 'parent' => 0,   'order' => 1 ]);
        Category::create([ 'id' => 185 , 'name' => 'DIETA PARA CELÍACO' , 'parent' => 184, 'order' => 1 ]);
